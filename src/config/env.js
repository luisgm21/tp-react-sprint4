...
export const API_CONFIG = {
  RICKANDMORTY_CHARACTERS_API_URL: import.meta.env.VITE_RICKANDMORTY_CHARACTERS_API_URL || 'https://rickandmortyapi.com/api/character',
...
if (API_CONFIG.NODE_ENV === 'development') {
  console.log('Environment Config:', {
    API_URL: API_CONFIG.RICKANDMORTY_CHARACTERS_API_URL,
